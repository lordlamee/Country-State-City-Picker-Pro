...
class CountryStateCityPickerPro {
  static final _instance = CountryStateCityPickerPro._();
  CountryStateCityPickerPro._();

  factory CountryStateCityPickerPro() {
    return _instance;
  }
  ...
  void _showDialog(BuildContext context, String country) {
